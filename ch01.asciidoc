...
您可以在本书附带的代码中看到这个操作。一旦您设置好Jupyter Notebook（请参阅<<设置>>），您就可以导航到 _code-ch01/Chapter1.ipynb_ 并运行代码以查看结果。 下一个练习，您需要打开 _ecc.py_，通过点击练习1框中的链接来访问。 如果您遇到困难，请记住每个练习的答案都在<<附录解决方案>>中。
...
有限域((“finite fields”，“modulo arithmetic”，id=“FFmodulo01”))中，我们可以使用模运算((“modulo arithmetic”，id=“modulo01”))这一工具，使得有限域在加法、减法、乘法和除法下封闭。
